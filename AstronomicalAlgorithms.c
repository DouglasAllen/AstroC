/*
AstronomicalAlgorithms main source file, implementing the book examples.
The \#ifdef PAGE_nnn_TEST directives in AstronomicalAlgorithms.h are used
to include/exclude the related code.
...
int main(int iArgumentsCount, char *aszArguments[], char *aszEnvironment[])
   ...
   if (iArgumentsCount < 1)
      ...
      if (1)                                            /*lint !e506 !e774 */
         {
         short  sh1   = (short)  0;
         double doResult = (double) 0;

         sh1 = ShEclipsesJDE(&doResult, (double) 1993.38, (short) 0);
